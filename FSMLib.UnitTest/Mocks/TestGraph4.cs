	...
	*/
	...
	public class TestGraph4:Graph<char>
	{
		public TestGraph4()
		{
			...
			Nodes[4].Transitions.Add(new Transition<char>() { TargetNodeIndex = 5, Input = new AnyTerminalInput<char>() });
			Nodes[5].Transitions.Add(new Transition<char>() { TargetNodeIndex = 6, Input = new TerminalInput<char>() { Value = 'd' } });
