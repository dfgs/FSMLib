...
namespace FSMLib.SegmentFactories
{
	public class OneOrMoreSegmentFactory<T> : BaseSegmentFactory<OneOrMore<T>, T>
	{
		...
		public override Segment<T> BuildSegment( INodeContainer<T> NodeContainer, INodeConnector<T> NodeConnector, OneOrMore<T> Predicate, IEnumerable<BaseTransition<T>> OutTransitions)
		{
