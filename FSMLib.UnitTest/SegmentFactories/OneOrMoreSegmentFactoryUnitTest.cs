...
namespace FSMLib.UnitTest.SegmentFactories
{
	...
	public class OneOrMoreSegmentFactoryUnitTest
	{
		...
		public void ShouldFailWithNullParameters()
		{
			...
			Assert.ThrowsException<ArgumentNullException>(() => factory.BuildSegment( new MockedNodeContainer(), null, new OneOrMore<char>(), new EORTransition<char>().AsEnumerable()));
		...
		public void ShouldBuildSegmentFromNestedSequencePredicate()
		{
			...
			segment = factory.BuildSegment(graph, connector, predicate,new EORTransition<char>().AsEnumerable());
