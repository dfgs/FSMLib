...
namespace FSMLib.SegmentFactories
{
	public class AnySegmentFactory<T> : BaseSegmentFactory<Any<T>, T>
	{
		...
		public override Segment<T> BuildSegment(string Rule, INodeContainer<T> NodeContainer, INodeConnector<T> NodeConnector, Any<T> Predicate, IEnumerable<Transition<T>> OutTransitions)
		{
