...
namespace FSMLib.SegmentFactories
{
	public class ZeroOrMoreSegmentFactory<T> : BaseSegmentFactory<ZeroOrMore<T>, T>
	{
		...
		public override Segment<T> BuildSegment(string Rule, INodeContainer<T> NodeContainer, INodeConnector<T> NodeConnector, ZeroOrMore<T> Predicate, IEnumerable<Transition<T>> OutTransitions)
		{
			...
			// connect segments
			NodeConnector.Connect(Rule, segment.Outputs, segment.Inputs);
