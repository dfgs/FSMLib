...
namespace FSMLib.UnitTest.SegmentFactories
{
	...
	public class OneOrMoreSegmentFactoryUnitTest
	{
		...
		public void ShouldFailWithNullParameters()
		{
			...
			factory = new OneOrMoreSegmentFactory<char>(new MockedSegmentFactoryProvider<char>());
			Assert.ThrowsException<ArgumentNullException>(() => factory.BuildSegment( null, new MockedNodeConnector(), new OneOrMore<char>(), new EORTransition<char>().AsEnumerable()));
			Assert.ThrowsException<ArgumentNullException>(() => factory.BuildSegment( new MockedGraphFactoryContext(), null, new OneOrMore<char>(), new EORTransition<char>().AsEnumerable()));
			...
			Assert.ThrowsException<ArgumentNullException>(() => factory.BuildSegment( new MockedGraphFactoryContext(), new MockedNodeConnector(), new OneOrMore<char>(), null));
		}
		[TestMethod]
